...
Zephyr Product security tracking JIRA.  Issues within this bug
tracking system will transition through a number of states according
to this diagram:
...
Each Zephyr release shall contain a list of CVEs that have been
addressed by that release.  No additional details shall be included on
any CVEs that are still within their embargo period.
...
out the form at TBD_.  These parties will be vetted by the project
director to determine that they have a legimitate interest in knowing
about security vulnerabilities during the embargo period.

.. _TBD: http://example.com/
...
- The Security Incident Response team will have full access to
  information.
...
The Project Security Incident Response Team (PSIRT) will consist of one
volunteer from each member organization.  These members will be
categorized as either "active": those that are participating in the
security review process, and "observer": those that will receive
notification viea the PSIRT mailing list of the details of security
